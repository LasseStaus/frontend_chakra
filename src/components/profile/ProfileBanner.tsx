import { Box, Button, ButtonGroup, Container, Flex, Grid, GridItem, Heading, Spacer, Text, Wrap } from "@chakra-ui/react";
            ...
            >
                ...
                <GridItem colSpan={{ base: 4, md: 4 }} alignSelf="center">
                    <Flex justifyContent="start" direction={{ base: 'column', md: 'row' }} alignItems='center' gap={{ base: "2", md: "8" }}>
                        <Heading fontSize={{ base: "sm", md: "xl", lg: "3xl" }}>LASSE STAUSGAARD</Heading>
                        <Button w="40" variant="secondary" size="sm">Rediger Profil</Button>
                    </Flex>
                </GridItem>
